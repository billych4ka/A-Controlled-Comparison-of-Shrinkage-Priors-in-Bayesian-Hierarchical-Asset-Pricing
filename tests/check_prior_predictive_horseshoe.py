...
is established separately, by a total-log-density test against an
...
p_0 = 23, and Appendix A.7.7's second paragraph, the structural argument about
...
ones build_model declares, and that log-density check is what
