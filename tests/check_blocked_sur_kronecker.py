...
Reproduces Appendix A.7.1, second paragraph, and supports Section 4.4's
...
Recorded results (N=3 K=4 T=20, seed 0):
...
F_big = block_diag(*[F[i] for i in range(N)])
Om = np.kron(_spd_inverse(Sigma), np.eye(T))
